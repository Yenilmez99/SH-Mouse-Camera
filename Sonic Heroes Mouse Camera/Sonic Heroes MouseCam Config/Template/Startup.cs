...
using Sonic_Heroes_MouseCam_Config.Configuration;
using Sonic_Heroes_MouseCam_Config.Template.Configuration;

namespace Sonic_Heroes_MouseCam_Config.Template
{
